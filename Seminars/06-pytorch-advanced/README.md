...
Материалы составили: Феоктистов Дмитрий (@trandelik)

### Источники:

- [Документация PyTorch](https://docs.pytorch.org/docs/stable/index.html)

- [Руководства PyTorch](https://docs.pytorch.org/tutorials/recipes_index.html)
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mmp-practicum-team/mmp_dl_spring/blob/main/Seminars/06-pytorch-advanced/06-pytorch-advanced.ipynb)
