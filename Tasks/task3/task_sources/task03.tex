...
\begin{center}
    \begin{tabular}{|p{17.5cm}|}
        \hline
        \textbf{ВМК}\\
        \begin{center} \Large Задание 3. Hadoop. HDFS. MapReduce. \end{center}\\
        \textbf{Практикум 317 группы, весна 2025-2026}\\
        \hline
    \end{tabular}
\end{center}
...
\begin{tabbing}
    Начало выполнения задания: 1 апреля 2026 года, 15:00.\\
    Жёсткий Дедлайн: \textcolor{red}{\bf 8 апреля 2026 года, 03:00.}
\end{tabbing}
