...
| 13 апреля  | Занятие 23 | <ul><li>Обработка сигналов</li><li>Представления звука: Waveform, Спектрограмы</li><li>ASR: CTC, LAS, RNN-T</li></ul> | [Конспект](./Seminars/23-audio) |  | [Денойзинг аудио. Conformer]() |
...
| 21 апреля  | Занятие 27 | <ul><li>Обучение GAN</li><li>Архитектуры</li></ul> | [Конспект](./Seminars/27-gan-practice) |  | [Генерация 3D сцен. pi-GAN]() |
