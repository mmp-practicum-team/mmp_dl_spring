...
| 10 февраля | Занятие 02 | Обучение и регуляризация | [Конспект](./Seminars/02-init-reg) | | | 
| 10 февраля | Занятие 03 | Автоматическое дифференцирование | [Конспект](./Seminars/03-autodiff) | | [Полносвязная нейронная сеть на numpy]()|
