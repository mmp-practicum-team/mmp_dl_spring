...
| 10 февраля | Занятие 03 | Автоматическое дифференцирование | [Конспект](./Seminars/03-autodiff) | | [Полносвязная нейронная сеть на numpy](./Tasks/task1/task1.ipynb)|
| 16 февраля | Занятие 04 | PyTorch | [Конспект](./Seminars/04-pytorch-base) | | [Простейшая нейронная сеть на PyTorch](./Tasks/task1_5/task1_5.ipynb) | 
...
| 16 марта   | Занятие 13 | ul><li>Эмбеддинги слов</li><li>Дистрибутивная гипотеза</li><li>word2vec</li></ul> |  |  |  |
| 17 марта   | Занятие 14 | Работа с эмбеддингами |  |  |  |
| 23 марта   | Занятие 15 | Рекуррентные сети: теория |  |  | [Рекуррентные Нейронные Сети. Dropout. LM]() |
| 24 марта   | Занятие 16 | Рекуррентные сети: практика |  |  |  |
| 30 марта   | Занятие 17 | Трансформеры: теория |  |  |  |
| 31 марта   | Занятие 18 | <ul><li>Bert</li><li>GPT</li><li>seq2seq</li></ul> |  |  | [Hugging Face NLP]() |
| 31 марта   | Занятие 19 | Современные трансформеры |  |  |  |
...
| 20 апреля  | Занятие 25 | <ul><li>Задачи генеративного моделирования</li><li>GAN</li><li>WGAN</li></ul> |  |  |  |
| 21 апреля  | Занятие 26 | <ul><li>Обучение GAN</li><li>Архитектуры</li></ul> |  |  |  |
| 21 апреля  | Занятие 27 | <ul><li>Неявные представления в 3Д</li><li>Нейронные поля</li><li>NERF</li></ul>  |  |  | [Генерация 3D сцен. pi-GAN]() |
| 27 апреля  | Занятие 28 | <ul><li>Vision Transformers</li><li>Мультимодальные LLM</li><li>CLIP</li><li>LLaVA-based подход</li></ul>  |  |  |  |
| 28 апреля  | Занятие 29 | Практика мультимодальных моделей  |  |  |  |
