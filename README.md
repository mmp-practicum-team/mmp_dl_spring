...
| 02 марта   | Занятие 10 | Задачи компьютерного зрения: детекция, сегментация  | [Конспект](./Seminars/10-cv-advanced-tasks/) | | [Сегментация изображений](./Tasks/task2/task2.ipynb) | 
