...
| 26 февраля | Занятие 05 | PyTorch | | | [Простейшая нейронная сеть на PyTorch](./Tasks/task1_5/task1_5.ipynb) | 
...
| 12 марта   | Занятие 09 | Задачи компьютерного зрения: детекция, сегментация  | | | [Сегментация изображений](./Tasks/task2/task2.ipynb) | 
| 12 марта   | Занятие 10 | Практика решения задач компьютерного зрения | | | | 
| 19 марта   | Занятие 11 | ul><li>Эмбеддинги слов</li><li>Дистрибутивная гипотеза</li><li>word2vec</li></ul> |  |  |  |
| 19 марта   | Занятие 12 | Работа с эмбеддингами |  |  |  |
| 26 марта   | Занятие 13 | Рекуррентные сети: теория |  |  | [Рекуррентные Нейронные Сети. Dropout. LM]() |
| 26 марта   | Занятие 14 | Рекуррентные сети: практика |  |  |  |
| 02 апреля  | Занятие 15 | Трансформеры: теория |  |  |  |
| 02 апреля  | Занятие 16 | <ul><li>Bert</li><li>GPT</li><li>seq2seq</li></ul> |  |  | [Hugging Face NLP]() |
...
| 23 апреля  | Занятие 21 | <ul><li>Задачи генеративного моделирования</li><li>GAN</li><li>WGAN</li></ul> |  |  |  |
| 23 апреля  | Занятие 22 | <ul><li>Обучение GAN</li><li>Архитектуры</li></ul> |  |  |  |
| 30 апреля  | Занятие 23 | <ul><li>Неявные представления в 3Д</li><li>Нейронные поля</li><li>NERF</li></ul>  |  |  | [Генерация 3D сцен. pi-GAN]() |
| 30 апреля  | Занятие 24 | Диффузионные модели |  |  |  |
| 07 мая     | Занятие 25 | <ul><li>Vision Transformers</li><li>Мультимодальные LLM</li><li>CLIP</li><li>LLaVA-based подход</li></ul>  |  |  |  |
| 07 мая     | Занятие 26 | Практика мультимодальных моделей  |  |  |  |
