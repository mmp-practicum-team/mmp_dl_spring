...
[Введение в глубокое обучение 2025-2026, видеозаписи](https://www.youtube.com/playlist?list=PLhe7c-LCgl4IZgeTXsmBADlUwurF9czym).
...
- [Байесовские методы в машинном обучении, ММП](https://github.com/Bayesian-Methods-in-Machine-Learning) &ndash; применение байесовских методов для задач машинного обучения;

- [Нейробайесовские методы, ММП](https://github.com/Bayesian-Methods-in-Machine-Learning) &ndash; применение байесовских методов для задач глубокого обучения и генеративных моделей;
