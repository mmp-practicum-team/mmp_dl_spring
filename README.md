...
| 23 марта   | Занятие 15 | Рекуррентные сети: теория | [Конспект](./Seminars/15-rnn)  |  | [Рекуррентные Нейронные Сети. Dropout. LM]() |
| 24 марта   | Занятие 16 | Рекуррентные сети: практика | [Конспект](./Seminars/16-rnn-practice) |  |  |
| 30 марта   | Занятие 17 | Трансформеры: теория |  |  |  |
| 31 марта   | Занятие 18 | <ul><li>Bert</li><li>GPT</li><li>T5</li></ul> | [Конспект](./Seminars/18-bert-gpt-t5) |  | [Hugging Face NLP]() |
