...
| 20 апреля  | Занятие 25 | <ul><li>Неявные представления в 3Д</li><li>Нейронные поля</li><li>NERF</li></ul> |  |  |  |
| 21 апреля  | Занятие 26 | <ul><li>Задачи генеративного моделирования</li><li>GAN</li><li>WGAN</li></ul> |  |  |  |
| 21 апреля  | Занятие 27 | <ul><li>Обучение GAN</li><li>Архитектуры</li></ul> |  |  | [Генерация 3D сцен. pi-GAN]() |
| 27 апреля  | Занятие 28 | Табличные данные  |  |  |  |
| 28 апреля  | Занятие 29 | Графовые нейронные сети  |  |  |  |
| 04 мая     | Занятие 30 | <ul><li>Vision Transformers</li><li>Мультимодальные LLM</li><li>CLIP</li><li>LLaVA-based подход</li></ul>  |  |  |  |
| 05 мая     | Занятие 31 | Практика мультимодальных моделей  |  |  |  |
| 11 мая     | Занятие 32 | Авторегрессионные модели генерации изображений  |  |  |  |
